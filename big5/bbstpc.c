...
main ()
{
  ...
  printf ("<th class=title width=33%% align=left>同主題文章閱讀</th>\n");
  ...
  printf ("<tr><th class=body>序號<th class=body>狀態<th class=body>作者");
  ...
  if (strcmp (cookie.id, "guest") != 0)
    printf
      ("<th class=foot><a href=\"%s/bbspst?board=%s&title=%s%s\">發表文章</a>",
