...
main ()
{
  ...
  printf ("<title>%s[%s類]討論區列表</title>\n", BBSID,
	  SectNames[SectNumber][0]);
  printf ("<body>\n");
  printf ("<center>\n");

  printf ("<table class=title width=90%%><tr>");
  printf ("<th class=title width=33%% align=left>[討論區選單]</th>\n");
  printf ("<th class=title width=33%% align=center>%s</th>\n", BBSNAME);
  printf ("<th class=title width=34%% align=right>類別 [%s]</th>\n",
	  SectNames[SectNumber][0]);
  printf ("</table>\n");
  ...
  printf ("<th class=body>類別<th class=body>轉信<th class=body>中文描述");
  printf ("<th class=body>板主<th class=body>文章數</tr>\n");
