...
main ()
{
  ...
  cgi_html_head ();
  cgi_quit ();
  printf ("<title>%s全部讨论区列表</title>\n", BBSID);
  printf ("<body>\n");
  printf ("<center>\n");

  printf ("<table class=title width=90%%><tr>");
  printf ("<th class=title width=33%% align=left>全部讨论区</th>\n");
  ...
  printf ("<th class=body>类别<th class=body>转信<th class=body>");
  printf ("中文描述<th class=body>板主<th class=body>文章数</tr>\n");
