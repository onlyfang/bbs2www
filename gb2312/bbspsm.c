...
main ()
{
  ...
  printf ("<th class=title width=33%% align=left>发新邮件</th>\n");
  ...
  printf
    ("<tr><td class=post>邮件标题<td class=post colspan=2><input type=text name=title size=40 maxlength=100 ");
  printf ("value=\"");
  if (newfile == 0)
    {
