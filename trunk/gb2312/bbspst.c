...
main ()
{
  ...
  printf ("<th class=title width=33%% align=left>发表文章</th>\n");
  ...
  printf
    ("<tr><td class=post>使用标题 <input type=text name=title size=40 maxlength=100 ");
  printf ("value=\"");
  if (newfile == 0)
    {
  ...
  if (noname != 0)
  ...
  else
    {
      ...
      printf ("<input type=radio name=exchange value=Y checked>转信 ");
      printf ("<input type=radio name=exchange value=N>站内信件");
    }
